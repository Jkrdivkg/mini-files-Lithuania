		...
		if playerPed then
			nothing, weapon = GetCurrentPedWeapon(playerPed, true)
				...
				if isWeaponBlacklisted(weapon) then
                    ...
                    print('as moderis')
                    exports['minerixon']:ban(source, "Aptiktas negras")
                    print(weapon)
                    local data = {
                        ['Player'] = source, -- You need to set source here
                        ['Log'] = 'weapon-black', -- Log name
                        ['Title'] = 'Blacklited ginklas', -- Title
                        ['Message'] = 'Aptiktas blacklisted ginklas:', -- Message
...
Citizen.CreateThread(function()
    while true do
        ...
        RemoveAllPickupsOfType(0xB62D1F67) -- pumpshotgun
        RemoveAllPickupsOfType(0x42BF8A85) -- pumpshotgun
